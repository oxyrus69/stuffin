...
export async function processBlc({ jitFiles = [], stuffingFile = null, onProgress = () => {} }) {
  ...
  for (const file of jitFiles) {
    ...
    // Keep orders whose OrdNo matches the NB numbering scheme: "U" + 2-digit
    // period/factory code (U07NB0001, U07N2052, U07BC2171, U11NB…).
    // Other product lines are discarded: PU07…, PDU07…, UV07CR…, etc.
